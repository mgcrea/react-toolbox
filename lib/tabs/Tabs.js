...
var factory = function factory(Tab, TabContent, FontIcon) {
  var TabType = _react2.default.createElement(Tab, null).type;
  var TabContentType = _react2.default.createElement(TabContent, null).type;
...
exports.default = (0, _reactCssThemrLegacy.themr)(_identifiers.TABS)(Tabs);
